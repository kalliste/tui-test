...
const runTest = async (testId, testSuite, updateSnapshot, trace, tracePoints, importPath) => {
...
export async function runTestWorker(test, importPath, { timeout, updateSnapshot }, trace, pool, reporter, attempt, traceFolder) {
    const snapshots = [];
...
const testWorker = async (testId, testSuite, updateSnapshot, trace, importPath, attempt, traceFolder) => {
    ...
    try {
        await runTest(testId, testSuite, updateSnapshot, trace, tracePoints, importPath);
    }
    catch (e) {
        let errorMessage;
        if (typeof e == "string") {
